...
//define a route to handle the GET request from the form submission and log the query parameters and return the sum of the two numbers as a response
app.get('/target', (req, res) => {
    //log the query parameters to the console
    // console.log(req.query);
    // console.log(req.query.test1);
    // console.log(req.query.test2);
    const num1 = +req.query.test1;
    const num2 = +req.query.test2;
    const sum = num1 + num2;
