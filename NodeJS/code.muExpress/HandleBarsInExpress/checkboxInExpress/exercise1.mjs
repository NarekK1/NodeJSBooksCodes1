//make an input form with a checkbox and a text input. With input help ask the user name and say hi if checkbox is checked and say bye if checkbox is not checked
