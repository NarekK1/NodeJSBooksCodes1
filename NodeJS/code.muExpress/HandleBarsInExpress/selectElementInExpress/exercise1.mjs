//with select form element ask user for the country he is from
...
//route to render the form template to choose items
app.get('/', (req, res) => {
    //render the form template to choose items
    res.render('form');
});

//define a post route to handle form submission and log the selected items
app.post('/', (req, res) => {
