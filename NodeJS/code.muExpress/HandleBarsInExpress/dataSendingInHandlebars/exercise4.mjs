...
//get the path of the current file and directory
...
app.get('/exercise1', (req, res) => {
    //render the exercise1 template with text passed as data to the handlebars template
    res.render('exercise1', { name: '<h1>Jhon Doe</h1' });
});
