//Pass three date variables to the view. Apply the helper you created earlier to each of these variables, changing the date display format.
...
app.get('/page', (req, res) => {
    //send a date variable to the handlebars template
    res.render('page', { date: '2026-08-02' });
});
